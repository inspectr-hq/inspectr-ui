// src/components/settings/DialogMockLaunch.jsx
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 p-6 z-10">
        ...
        {serviceMode === 'proxy' ? (
          ...
          <>
            ...
            <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded">
              ...
              <p className="mt-2 text-sm text-yellow-800">
                To switch to mock mode, restart Inspectr with:
              </p>
              <pre className="mt-2 p-2 bg-gray-100 text-xs rounded overflow-auto">
                npx @inspectr/inspectr --mock-backend="{url}"
              </pre>
              <CopyButton textToCopy={`npx @inspectr/inspectr --mock-backend=${url}`} />
            </div>
            <p className="mb-4 text-sm text-gray-700">
              Follow the instructions above to start Inspectr as Mock server from the OpenAPI spec.
            </p>
          ...
          // Normal mock-configuration UI
          <>
            <p className="mb-2 text-sm text-gray-700">
              Inspectr lets you serve a mock API based on an OpenAPI spec.
            </p>
            <p className="mb-4 text-sm text-gray-700">
              You’re about to use <b>{url}</b> for mock responses. This will replace any existing
              mock configuration or catch-mode settings.
            </p>
