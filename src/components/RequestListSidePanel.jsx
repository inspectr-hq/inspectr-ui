...
const RequestListSidePanel = ({
  ...
  return (
    <div
      className={`
        fixed top-0 left-0 h-full w-80 bg-white shadow-xl transform transition-transform duration-300
    ...
    >
      ...
      <div className="p-4 overflow-y-auto h-full">
        ...
        <section className="mb-6">
          <h3 className="mb-3 text-xs font-bold text-gray-600 uppercase tracking-wide">Sort By</h3>
        ...
        {/* Filter Section */}
        <section>
          <h3 className="mb-3 text-xs font-bold text-gray-600 uppercase tracking-wide">Filters</h3>
