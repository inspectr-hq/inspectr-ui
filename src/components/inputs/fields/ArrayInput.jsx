// src/components/inputs/fields/ArrayInput.jsx
import React from 'react';

export default function ArrayInput({ id, descriptor, value, onChange, readOnly }) {
  ...
  const placeholder = descriptor.placeholder || 'tag.one, tag.two';
  const inputClass =
