...
const ToastNotification = ({ message, subMessage, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white border-l-4 border-green-500 p-2 shadow-lg rounded-lg">
        <div className="flex items-start">
          ...
          <div className="ml-1 flex-1">
            ...
            <div
              className="w-full h-1 rounded-t-lg bg-green-500"
